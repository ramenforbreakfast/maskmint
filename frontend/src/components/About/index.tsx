    ...
    return (
        <React.Fragment>
            <div className="flex flex-row justify-center items-center p-3">
                <h1 className="text-xl font-mono">Deploy ERC-20 Tokens For HashMasks, Tokens Can Only Be Minted By</h1>
                <FireIcon className="h-10 w-10 text-yellow-600"></FireIcon>
            ...
            <div className="flex flex-row justify-center items-start space-x-3">
                ...
                <div className="p-5 border-4 rounded-lg border-gray-500 w-1/4 bg-gray-200">
                    ...
                    <p className="text-xl text-center font-mono">Manage/Deploy Contracts for Masks You Own</p>
                    <BriefcaseIcon className="h-20 w-20 mx-auto text-yellow-500"></BriefcaseIcon>
                    <ul className="list-disc list-inside leading-relaxed font-mono">
                ...
                <div className="p-5 border-4 rounded-lg border-gray-500 w-1/4 bg-gray-200">
                    ...
                    <p className="text-xl text-center font-mono">Sponsor the Deployment of a Mask Token Contract</p>
                    <GiftIcon className="h-20 w-20 mx-auto text-yellow-500"></GiftIcon>
                    <ul className="list-disc list-inside leading-relaxe font-mono">
